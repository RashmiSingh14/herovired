...
position b and returns a boolean representation of whether it's possible to earn a bonus on any dice roll.
...
function possibleBonus(a,b){
    var result =  b-a;
    if(a>=b){
        console.log('My position : ' + a, ' My friends position : ' + b, ' --> false');
    }else
    if(result<=6){
        console.log('My position : ' + a, ' My friends position : ' + b, ' --> true');
    }else
    {
        console.log('My position : ' + a, ' My friends position : ' + b, ' --> false');
    }
